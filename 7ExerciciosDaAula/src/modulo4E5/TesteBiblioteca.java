...
public class TesteBiblioteca {
    public static void main(String[] args) {
        ...
        Usuario estudante = new Estudante("Ana Silva", "ana@email.com", "E001", "ADS");
        Usuario professor = new Professor("Dr. João", "joao@email.com", "P001", "TI");
        Usuario funcionario = new Funcionario("Pedro Alberto", "pedroalberto@email.com", "F001", 888777);
        Usuario usuarioExterno = new UsuarioExterno("Carlos Pereira", "carlospereira@email.com", "UE001", 23234);
